...
const Kontakt = () => {
  return (
    <div className="kontaktContainer">
      <div className="kontaktBox1 kontakt">
        <img src={HeroK2} alt="" />
      </div>
      <div className="kontaktBox2 kontakt">
        <h1>Kontakt</h1>
      </div>
      <div className="kontaktBox3  kontakt">
      ...
      <div className="kontaktBox4 kontakt">
      ...
      <div className="kontaktBox5 kontakt">
