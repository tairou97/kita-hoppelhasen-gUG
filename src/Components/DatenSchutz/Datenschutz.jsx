...
const Datenschutz = () => {
  return (
    <div className="DatenSchutz">
      ...
      <p>
        Mustafa Tinmaz / Kita Hoppelhasen gUG (haftungsbeschränkt){""}
        Mandrellaplatz 3, {""}12555 Berlin
      </p>
      <p>Vertretungsberechtigte Personen: Mustafa Tinmaz</p>
      <p>
        E-Mail-Adresse:{" "}
        <a href="mailto:kita-hoppelhasen@web.de">kita-hoppelhasen@web.de</a>
      </p>
      <p>Telefon: 030/257 396 54</p>
      ...
      <ul>
        ...
        <li>
          ...
          Organisations- und Verwaltungsverfahren. Öffentlichkeitsarbeit und
          Informationszwecke.
        </li>
        <li>
      ...
      <ul>
        <li>
          ...
          Kontaktdaten für Presse und Medienbeziehungen sowie die Organisation
          und Durchführung von Pressekonferenzen und öffentlichen
          Veranstaltungen. Die Erstellung von Informationsmaterialien beinhaltet
          das Sammeln und Aufbereiten von Informationen für Pressemitteilungen,
          Newsletter, Berichte und andere Publikationen. Die Verbreitung erfolgt
          über digitale und traditionelle Kanäle, einschließlich
          E-Mail-Verteiler, Websites und soziale Medien. Die Pflege von
          Kontaktdaten umfasst die Erfassung und Aktualisierung von Daten der
          Medienkontakte und anderer relevanter Interessengruppen. Die
          Organisation von Pressekonferenzen und Veranstaltungen beinhaltet die
          Planung und Durchführung dieser Ereignisse, das Einladungsmanagement
          und die Koordination der Veranstaltungslogistik. Die Interaktion mit
      ...
      <p>
        <strong>Hinweise zu datenschutzrechtlichen Rechtsgrundlagen: </strong>Ob
