    ...
    <section className="tagesablauf">
      ...
      <div className="bringzeit">
        ...
        <p>
          ...
          Abschied zu nehmen, während die Kinder Zeit haben, anzukommen und sich
      ...
      <div className="morgenkreis">
        ...
        <p>
          ...
          Kinder haben außerdem Zeit für Freispiel, in dem sie eigene Ideen und
      ...
      <div className="ruhezeit">
        ...
        <p>
          ...
          neue Energie für den Nachmittag tanken können. Diese Pause ist wichtig
          für das Wohlbefinden und die gesunde Entwicklung der Kinder.
        </p>
      </div>
      <div className="vesper">
        <strong>Vesper:</strong> 13:30 Uhr
        <p>
          Die Kinder nehmen einen kleinen Snack ein, um ihren Hunger zu stillen.
          Danach haben sie Zeit für Freispiel oder Gartenzeit, in der sie
          draußen spielen und sich an der frischen Luft bewegen können.
        </p>
      </div>
